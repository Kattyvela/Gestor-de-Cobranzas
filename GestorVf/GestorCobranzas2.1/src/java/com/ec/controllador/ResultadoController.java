...
import com.ec.facade.ResultadoFacade;
...
public class ResultadoController implements Serializable {
    ...
    @EJB
    private com.ec.facade.ResultadoFacade ejbFacade;
    ...
    public Resultado getResultado(java.lang.Integer id) {
    ...
    public static class ResultadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Resultado) {
                ...
                return getStringKey(o.getIdResultado());
            } else {
