...
import com.ec.facade.AbonoDeudaFacade;
...
public class AbonoDeudaController implements Serializable {
    ...
    @EJB
    private com.ec.facade.AbonoDeudaFacade ejbFacade;
    ...
    public AbonoDeuda getAbonoDeuda(java.lang.Integer id) {
    ...
    public static class AbonoDeudaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof AbonoDeuda) {
                ...
                return getStringKey(o.getIdAbonodeuda());
            } else {
