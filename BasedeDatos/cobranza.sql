...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Usuario_unidad_negocio` (
...
CREATE  TABLE IF NOT EXISTS `Mora` (
  ...
  CONSTRAINT `fk_Mora_Usuario_unidad_negocio1`
    ...
    REFERENCES `Usuario_unidad_negocio` (`id_Usuario_unidad_negocio` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE  TABLE IF NOT EXISTS `Abono_Deuda` (
  ...
  CONSTRAINT `fk_Abono_Deuda_Mora1`
    ...
    REFERENCES `Mora` (`id_Mora` , `Usuario_unidad_negocio_id_Usuario_unidad_negocio` , `Cliente_id_Cliente` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
